...
namespace compSciRevisionTool
{
    public partial class Form1 : Form
    {
        ...
        private void loadMenuItems()
        {
            ...
            var sub4_02 = generateSubMenuChildButton(sub4, 1, new binaryTreeMain(), "Tree", "5");
            renderPanel(sub4, 3);
        }
        ...
        private void Form1_Load(object sender, EventArgs e) //on form1 load
        {
            ...
            openSubForm(new subformHome("10"), icBtnHome, "10"); // on load, preselect the home button and load home
