...
{
    public partial class formDesignForInformationForms : formDesign
    {
        ...
        public formDesignForInformationForms()
        {
            InitializeComponent();
        }

        private void formDesignForInformationForms_Load(object sender, EventArgs e)
        {
